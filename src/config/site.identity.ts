export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'prairiebug',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Prairiebug',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'prairiebug.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://prairiebug.com',
