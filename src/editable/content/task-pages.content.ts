...
export const taskPageVoices = {
  ...
  sbm: {
    eyebrow: 'The Library',
    headline: 'Curated resources, tools, and collections worth saving.',
    description: 'Browse hand-picked resources organized into collections. Every link goes directly to the source — no friction, no sign-up walls.',
  ...
  profile: {
    ...
    description: 'Curators who submit, organize, and maintain the resources in the library.',
